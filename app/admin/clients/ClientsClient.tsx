          ...
          {clients.length === 0 ? (
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-white/25 mb-4">
                {hasFilters ? "Sin clientes que coincidan" : "Aún no hay clientes"}
              </p>
              {!hasFilters && (
                <button
                  onClick={openCreate}
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 mb-0.5">
                        <Link href={`/admin/clients/${c.id}`} className="text-sm font-medium text-white truncate hover:underline underline-offset-2">
                          {c.name}
                        </Link>
                        {!c.active && (
