...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/6 backdrop-blur-md bg-[#050d1a]/85">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        {/* Wordmark */}
        <a href="#" className="flex items-center gap-2.5 group select-none">
          <svg
            className="w-[17px] h-[21px] text-blue-400 group-hover:text-blue-300 transition-colors shrink-0"
            viewBox="0 0 18 22"
            fill="none"
            stroke="currentColor"
        ...
        <div className="flex items-center gap-2">
          <a
            href="#contacto"
            className="text-sm px-4 py-2 md:px-5 rounded-full bg-blue-600 text-white hover:bg-blue-500 transition-colors font-medium"
          >
            Hablemos
          </a>
          <button
      ...
      {open && (
        <div className="md:hidden border-t border-white/6 bg-[#050d1a] px-6 py-5 flex flex-col gap-5">
