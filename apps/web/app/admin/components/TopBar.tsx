...
const BREADCRUMBS: Record<string, string> = {
  ...
  "/admin/appointments/services":    "Appointments · Services",
  ...
  "/admin/customers/suppliers":      "Customers · Suppliers",
  "/admin/customers/":               "Customers · Profile",
    ...
    <header className="h-14 shrink-0 flex items-center justify-between px-5 bg-[#0a1628] border-b border-white/8">
      ...
      <div className="flex items-center gap-1">
        {isViewing && (
          <button
            onClick={stopViewing}
            title={t.admin.common.stopViewing}
