          ...
          {step === "totp-setup" && (
            <div className="space-y-4">
              <p className="text-xs text-white/50">
                Open <strong className="text-white/70">Google Authenticator</strong> or <strong className="text-white/70">Authy</strong>, tap <strong className="text-white/70">+</strong> → <strong className="text-white/70">Enter a setup key</strong>.
              </p>
