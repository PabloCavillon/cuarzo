...
const INCOME_CATEGORIES  = ["Sale", "Collection", "Deposit", "Other"];
const EXPENSE_CATEGORIES = ["Purchase", "Fixed expense", "Variable expense", "Withdrawal", "Provider", "Tax", "Other"];
const PAYMENT_METHODS    = ["cash", "transfer", "card", "mercadopago", "check"];
...
function MovModal({
  ...
  const categorias = tipo === "ingreso" ? INCOME_CATEGORIES : EXPENSE_CATEGORIES;
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-white/50 mb-1.5">
              Amount <span className="text-red-400/70">*</span>
            </label>
            <input
              name="monto"
              type="number"
          ...
          <div>
            ...
            <input
              ...
              required
              placeholder="e.g. Sale to García"
              className={inputCls}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Método de pago */}
            <div>
              <label className="block text-xs font-medium text-white/50 mb-1.5">Method</label>
          ...
          {movimientos.length === 0 ? (
            <div className="py-16 text-center">
              ...
              <p className="text-sm text-white/25 mb-4">
                {hasFilters ? "No movements for the period" : "No movements yet"}
              </p>
              {!hasFilters && (
                <button
                  onClick={() => setModal({ mode: "create" })}
